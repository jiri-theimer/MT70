...
namespace BL
{
    ...
    {        
        public p31ColumnsProvider()
        {
            ...
            oc = AF("p31Rate_Billing_Orig", "Hodinová sazba", null, "num");oc.IHRC = true;oc.DefaultColumnFlag = gdc1;
