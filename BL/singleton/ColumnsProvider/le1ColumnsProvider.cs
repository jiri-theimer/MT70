...
namespace BL
{
    public class le1ColumnsProvider: ColumnsProviderBase
    {
        public le1ColumnsProvider()
        {
            ...
            oc = AF("PrirazenyCenik", "Přiřazený fakturační ceník", "le1p51billing.p51Name"); oc.RelSqlInCol = "LEFT OUTER JOIN p51PriceList le1p51billing ON a.p51ID_Billing=le1p51billing.p51ID";
            oc = AF("SkutecnyCenik", "Skutečný fakturační ceník", "dbo.get_billing_pricelist_name(a.p41ID,a.p28ID_Client)");
            oc = AF("FakturacniJazyk", "Fakturační jazyk", "p87le1.p87Name"); oc.RelSqlInCol = "LEFT OUTER JOIN p87BillingLanguage p87le1 On a.p87ID=p87le1.p87ID";
