...
namespace BL
{
    public class TheEntitiesProvider
    {
        ...
        private void SetupPallete()
        {
            ...
            AE("p31Worksheet", "Úkony", "Úkon", "p31Worksheet a INNER JOIN p41Project p41x ON a.p41ID=p41x.p41ID INNER JOIN p32Activity p32x ON a.p32ID=p32x.p32ID INNER JOIN p34ActivityGroup p34x ON p32x.p34ID=p34x.p34ID", "a.p31ID DESC");            
