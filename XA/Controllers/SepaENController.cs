...
{
    public class SepaENController : Controller
    {
        public IActionResult Index()
        {
            ...
            items[0].DrctDbtTx.MndtRltdInf = new MandateRelatedInformation6() { MndtId = strClientID, DtOfSgntr = datPodepsaniMandatu, AmdmntInd=true }; //číslo mandátu (dohody o inkasování mezi příjemcem a plátcem
