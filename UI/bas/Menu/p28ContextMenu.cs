...
namespace UI.Menu
{
    public class p28ContextMenu: BaseContextMenu
    {
        public p28ContextMenu(BL.Factory f, int pid) : base(f, pid)
        {
            ...
            AMI("Nová poznámka/odkaz/příloha", $"javascript: _window_open('/b07/Record?prefix=p28&pid=0&recordpid={pid}')", "k-i-comment", "more");
            AMI("Nový dokument", $"javascript: _window_open('/o23/Record?prefix=p28&pid=0&recordpid={pid}')", null, "more");
